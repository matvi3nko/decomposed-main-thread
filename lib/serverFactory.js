...
module.exports.case11 = function () {
    startCluster(() => {
        ...
        process.stderr.write(`
        Server: Napa cluster
        CpuTask: in Napa thread
        APM: ––
    `);
    });
};

module.exports.ssr = function () {
    process.stderr.write(`CLUSTER \n`);
    startCluster(() => {
        createExpressWithReactServer(config);
        process.stderr.write(`
        Server: Express with React 
        CpuTask: in Napa thread
        APM: ––
    `);
    });
